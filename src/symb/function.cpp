 ...
 */
Function::Function(std::string n, Type *resType, Location *l, int count) {
...
size_t Function::getParamCount(void) { return paramCount; }

bool Function::isDefined(void) { return defined; }

void Function::tryDefine(bool flag) { defined |= flag; }
