...
class Call : public Expr {
  public:
	Call(std::string name, ExprList *exprs, Location *l);
	virtual void accept(Visitor *);
	// virtual void dumpTo(std::ostream &);
...
class WhileStmt : public Statement {
  public:
	WhileStmt(Expr *cond, Statement *body, Location *l);
...
class DoWhileStmt : public Statement {
  public:
	DoWhileStmt(Expr *cond, Statement *body, Location *l);
 ...
 *   (while CONDITION LOOP_BODY)
 */
class ForExprStmt : public Statement {
  public:
	ForExprStmt(Expr *sta_expr, Expr *cond, Expr *rep, Statement *body, Location *l);

	virtual void accept(Visitor *);
//	virtual void dumpTo(std::ostream &);

  public:
	Expr *start_expr, *condition, *repeat;
	Statement *loop_body;
	scope::Scope *ATTR(scope);
};
class ForDeclStmt : public Statement {
  public:
	ForDeclStmt(VarDecl *sta_decl, Expr *cond, Expr *rep, Statement *body, Location *l);
