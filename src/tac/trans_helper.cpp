 ...
 */
Temp TransHelper::getNewTempI4(bool is_global, std::string str) {
...
void TransHelper::genGetParam(Temp src, int count) { chainUp(Tac::getParam(src, count)); }

void TransHelper::genParam(Temp src, int count) { chainUp(Tac::Param(src, count)); }
